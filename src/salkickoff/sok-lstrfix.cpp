...
//#error compiling lstrfix.inc with lstrfix_without_rtl defined
#pragma message("******** compiling lstrfix.inc with lstrfix_without_rtl defined")
...
#elif COMPILING_SALOPEN == 1

//#error inside COMPILING_SALOPEN defined for lstrfix.include 'file';
#pragma message("inside COMPILING_SALOPEN defined for lstrfix.include 'file'")
